...
use AnimalBundle\Media\Uploader;
use Gaufrette\Filesystem;
use HWI\Bundle\OAuthBundle\OAuth\Response\UserResponseInterface;
use HWI\Bundle\OAuthBundle\Security\Animal\User\FOSUBUserProvider as BaseClass;
use Intervention\Image\ImageManager;
use Symfony\Component\HttpFoundation\RedirectResponse;
use Symfony\Component\Security\Animal\User\UserInterface;
...
class FOSUBUserProvider extends BaseClass
{
    ...
    {
        $user = $this->userManager->findUserByAnimal($response->getAnimal());
        if ($user) {
        ...
        if (null === $user) {
            ...
            if (!empty($response->getAnimal())) {
                $Animal = $response->getAnimal();
            } else {
                $Animal = $username;
            }
